...
# REMOVED the `with app.app_context()` block from here.

if __name__ == '__main__':
    # For local development, we ensure tables are created before running.
    # On Render, `flask db upgrade` in start.sh handles this.
